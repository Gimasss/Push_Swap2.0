...
/*   Updated: 2025/01/23 18:11:03 by giomastr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_printf(const char *form, ...)
{
	...
	while (form[i] != '\0')
	{
		if (form[i] == '%' && form[i + 1]) //check su form[i + 1] opz.
...
int main()
{
    ...
    // // Mixed formats stress test
    ft_printf("%d%x%X%s%c%p%i%u\n", 42, 42, 42, "42", '4', &"42", 42, 42);
	printf("%d%x%X%s%c%p%i%u\n", 42, 42, 42, "42", '4', &"42", 42, 42);
    ...
    // Long strings
    ft_printf("%s\n", "ThisIsAVeryLongStringThatMightCauseIssuesIfTheBufferIsNotHandledProperly");
	printf("%s\n", "ThisIsAVeryLongStringThatMightCauseIssuesIfTheBufferIsNotHandledProperly");
} */
